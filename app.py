...
if ENV == "dev":
    ...
    app.debug = False
    app.config['SQLALCHEMY_DATABASE_URI'] = 'postgres://faczclvhitvdwh:ae3089dce8da2eadfc810e426aa0d464be78d7fdb44a8d3792c94fbd5bfadd0a@ec2-54-224-120-186.compute-1.amazonaws.com:5432/d5rg047ldjvf8m'
